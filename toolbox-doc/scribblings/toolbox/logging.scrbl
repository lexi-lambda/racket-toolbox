...
A @reftech{logger} used by various functions in this library. Generally, messages are not written to @racket[toolbox-logger] directly, but it serves as a parent logger for module-specific loggers, such as @racket[toolbox:db-logger].}
